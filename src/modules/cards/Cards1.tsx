            ...
            <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
              ...
              >
                ...
                <div className="py-2 px-9 relative  ">
                  ...
                  >
                    <path d="M460.4,234.3l-91.7-91.7c-7.9-7.9-16.5-4.1-28.5-4.9c0.6,6.5,1.2,13.2,1.6,20.1c17.1,10,20.8,34.3,6.1,49c-12.2,12.2-32,12.3-44.4,0c-14.9-14.9-10.7-39.5,6.2-49.2c-0.4-6.7-0.9-13.1-1.6-19.3l-11.2,0.2c-9.5,0.2-17.2,7.8-17.3,17.3l-1.1,59c-0.1,4.8,1.8,9.4,5.2,12.8l91.7,91.7c7.1,7,18.2,6.8,25,0l60.1-60.1C467.3,252.4,467.3,241.2,460.4,234.3z M348,252.7c-2.1-2.1-2.1-5.5,0-7.5l38.1-38.1c2.1-2.1,5.5-2.1,7.5,0c2.1,2.1,2.1,5.5,0,7.5l-38.1,38.1C353.5,254.7,350.1,254.7,348,252.7z M373.6,270.7c-2.1,2.1-5.5,2.1-7.5,0c-2.1-2.1-2.1-5.5,0-7.5l38.1-38.1c2.1-2.1,5.5-2.1,7.5,0s2.1,5.5,0,7.5L373.6,270.7z M429.7,250.5l-38.1,38.1c-2.1,2.1-5.5,2.1-7.5,0c-2.1-2.1-2.1-5.5,0-7.5l38.1-38.1c2.1-2.1,5.5-2.1,7.5,0S431.8,248.5,429.7,250.5z"></path>
                    <path d="M340.3 199.3c-8.1 8.1-21.3 8.1-29.3 0-11.3-11.4-6.1-30.9 9.7-34.7C317 79.3 288.3 10.7 255.9 10.7c-32.2 0-60.8 68.4-64.6 153.4 8.8 2.6 15.3 10.6 15.3 20.3 0 11.6-9.5 21.1-21.1 21.1s-21.1-9.5-21.1-21.1c0-10 7-18.4 16.3-20.6C184.8 70.1 216.9 0 255.9 0c39.4 0 71.5 70.6 75.5 164.9C346.8 169.2 351.2 188.4 340.3 199.3zM404.6 140.4L404.6 140.4c-2.6-12.9-14-22.3-27.1-22.3h-39.8c.5 2.9.9 5.9 1.2 9 10.4.9 25.1-4.3 37.2 7.9l34.1 34.1L404.6 140.4z"></path>
                  ...
                  <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white ">
                    FMCG, Cosmetics, labels, Packaging
                  </h3>
                  <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                    Amet minim mollit non deserunt ullamco est sit aliqua dolor
                    do amet sint. Velit officia consequat duis enim velit
              ...
              >
                ...
                <div className="py-2 px-9 relative  ">
                  <svg
                    ...
                    id="socket"
                  >
                    <path d="M10,37H24a2,2,0,0,0,2-2V5a2,2,0,0,0-2-2H10A2,2,0,0,0,8,5V35A2,2,0,0,0,10,37ZM10,5H24V35H10Z"></path>
                    <path d="M29 8V41.538A1.464 1.464 0 0127.538 43H18.593A.593.593 0 0118 42.408V40h2a1 1 0 000-2H14a1 1 0 000 2h2v2.408A2.6 2.6 0 0018.593 45h8.945A3.466 3.466 0 0031 41.538V8a3 3 0 016 0v6.142A4 4 0 0034 18v3a1 1 0 001 1v1a1 1 0 002 0V22h2v1a1 1 0 002 0V22a1 1 0 001-1V18a4 4 0 00-3-3.858V8A5 5 0 0029 8zM40 18v2H36V18a2 2 0 014 0zM17 7a6 6 0 106 6A6.006 6.006 0 0017 7zm0 10a4 4 0 114-4A4 4 0 0117 17z"></path>
                    <path d="M17,21a6,6,0,1,0,6,6A6.006,6.006,0,0,0,17,21Zm0,10a4,4,0,1,1,4-4A4,4,0,0,1,17,31Z"></path>
                    <path d="M18 26H16a1 1 0 000 2h2a1 1 0 000-2zM18 12H16a1 1 0 000 2h2a1 1 0 000-2zM38.046 38.887a1 1 0 001.3-.557l1.583-3.958A1 1 0 0040 33H38.477l1.047-2.619a1 1 0 10-1.857-.742l-1.6 3.99A1 1 0 0037 35h1.523l-1.035 2.586A1 1 0 0038.046 38.887z"></path>
                  </svg>
                  <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white ">
                    Home appliances/ Electrical industry
                  </h3>
                  <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                    Amet minim mollit non deserunt ullamco est sit aliqua dolor
                    do amet sint. Velit officia consequat duis enim velit
                ...
                <div className="py-2 px-9 relative  ">
                  ...
                  >
                    <g data-name="Layer 14">
                      ...
                      <polyline
                        fill="#76868c"
                        points="50 8 44 8 44 12 50 12"
                      ></polyline>
                      <polyline
                        fill="#76868c"
                        points="50 52 44 52 44 56 50 56"
                      ></polyline>
                      <rect
                        width="9.192"
                        height="2"
                        ...
                        y="10.75"
                        fill="#fff"
                        transform="rotate(-45 32.25 11.75)"
                      ></rect>
                      <rect
                        width="9.192"
                        height="2"
                        ...
                        y="16.75"
                        fill="#fff"
                        transform="rotate(-45 32.25 17.75)"
                      ></rect>
                      <polygon
                        fill="#76868c"
                      ...
                      <rect
                        ...
                        y="45.25"
                        fill="#fff"
                        transform="rotate(-45 32.25 46.25)"
                      ></rect>
                      <rect
                        width="9.192"
                        height="2"
                        ...
                        y="51.25"
                        fill="#fff"
                        transform="rotate(-45 32.25 52.25)"
                      ></rect>
                      <rect
                        width="6"
                        height="2"
                ...
                <div className="py-2 px-9 relative  ">
                  ...
                  >
                    <g
                      id="_36"
                      data-name="36"
                      transform="translate(-410 -1086.604)"
                    >
                      <path
                        id="Path_131"
                        data-name="Path 131"
