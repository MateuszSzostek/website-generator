...
export default function Pricing2() {
  return (
    <Section>
      <div className="bg-[#ffd148] flex items-center justify-center min-h-screen relative z-10">
        ...
        <div className="w-full max-w-[1190px] px-6 sm:px-8 md:px-16 py-10 md:py-20 rounded-xl bg-[#ffffff]/60 min-h-[300px] m-2 shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.21)]">
          ...
          <small className="font-[500]">
            In the event that we do not have a full 30-days, we extrapolate
          ...
          <ul className="flex items-start justify-between gap-8 mt-10 md:flex-row flex-col">
            ...
            <li className="w-full lg:w-[32%] px-10 pt-16 pb-8 bg-white rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl text-white px-8 py-2 bg-[#ff2865] transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
                Hot take!
              </div>
              <h2 className="text-center font-semibold text-lg tracking-wider mb-3 drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">
                Sidebar Block
            ...
            <li className="w-full lg:w-[32%] px-10 pt-16 pb-8 bg-white rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl bg-[#e2e2e2] text-black px-8 py-2 group-hover:bg-red-800 group-hover:text-white transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
                Sold Out
              </div>
              <h2 className="text-center font-semibold text-lg tracking-wider mb-3 drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">
                Premium Sidebar
              ...
              <button className="w-full p-2 bg-transparent text-[#13181f] rounded-md font-semibold hover:bg-[#13181f] hover:text-white transition-all duration-150 ease-in mb-8 border border-[#13181f]">
                get on the waiting list
              </button>
              <ol className="list-disc text-[#ff2865] w-[80%] mx-auto">
                <li>
                  <span className="text-black text-xs font-semibold">
                    2,000,000 Est. Impressions
                  </span>
                </li>
                <li>
                  <span className="text-black text-xs font-semibold">
