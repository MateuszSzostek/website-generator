...
export default function ModuleFormStats({ register, id, remove }: IModuleForm) {
  return (
    <div className="border p-2 flex flex-col">
      <h2>Stats Component</h2>
      <label htmlFor="stats-title">Title</label>
      <input name="stats-title" {...register(`modules[${id}].module.title`)} />
      <label htmlFor="stats-title">Description</label>
      <input
