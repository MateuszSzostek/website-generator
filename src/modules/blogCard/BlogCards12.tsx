...
export default function BlogCards12() {
  return (
    <Section>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <div className="rounded overflow-hidden flex flex-col max-w-2xl mx-auto border">
          <div className="sm:flex justify-between items-center pt-4 px-5">
            <a
              href="#"
              className="sm:w-8/12 font-medium text-md inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
            >
          ...
          <div className="relative">
            ...
            <a
              href="#!"
              className="hidden absolute z-10 text-xs absolute bottom-0 left-0 bg-indigo-600 px-6 m-2 py-2 text-white hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out sm:flex items-center"
            >
